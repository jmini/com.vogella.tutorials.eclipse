...
To provide a code templates based on this extension point, create a new plug-in called `com.vogella.jdt.templates`.
...
[source, language]
----
include::examples/additional-templates.xml[]
